/**
 * Provides the function {@linkcode atomic} which is like
 * `Deno.Kv#atomic()` but will work around the limitation 10 transactions per
 * atomic operation.
 *
 * @author Kitson Kelly <https://github.com/kitsonk>
 * @see https://github.com/kitsonk/kv_toolbox
 * @module
 */
...
export function atomic(kv: Deno.Kv, options?: { batchSize?: number }) {
  return new Atomic(kv, options);
}
